...
class Graph {
    ...
    static int totalCombinations = 0; // Static variable to store the number of combinations
    ...
    private void allTopologicalSortsUtil(boolean[] visited,
        ...
        if (!flag) {
            totalCombinations++; // Increment total combinations
            System.out.print("\\#" + totalCombinations + " & ");
            stack.forEach(i -> System.out.print((char) (i + 'A') + " "));
            System.out.println("\\\\");
